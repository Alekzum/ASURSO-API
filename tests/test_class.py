from . import async_asurso, sync_asurso, rejoin_asurso, mark_asyncio, pytest, wrap_coro
...
@pytest.mark.usefixtures("rejoin_asurso")
@mark_asyncio
class TestClass:
    async def test_logout(self, asurso: Union[classes.ASURSO, classes.AsyncASURSO]):
        logout_success = await wrap_coro(asurso.logout())
        print(logout_success)
        assert isinstance(logout_success, bool)

    async def test_login(self, asurso: Union[classes.ASURSO, classes.AsyncASURSO]):
    ...
    async def test_attestation(
        self, asurso: Union[classes.ASURSO, classes.AsyncASURSO]
    ):
    ...
    async def test_chats(self, asurso: Union[classes.ASURSO, classes.AsyncASURSO]):
    ...
    async def test_current_performance(
        self,
        asurso: Union[classes.ASURSO, classes.AsyncASURSO],
    ):
    ...
    async def test_dashboard(self, asurso: Union[classes.ASURSO, classes.AsyncASURSO]):
    ...
    async def test_info(self, asurso: Union[classes.ASURSO, classes.AsyncASURSO]):
        info = await wrap_coro(asurso.get_info())
        print(info)
        assert isinstance(info, classes.Info)

    async def test_lessons(self, asurso: Union[classes.ASURSO, classes.AsyncASURSO]):
    ...
    async def test_context(self, asurso: Union[classes.ASURSO, classes.AsyncASURSO]):
        await wrap_coro(asurso.logout())
        if isinstance(asurso, classes.ASURSO):
            with asurso:
                info = asurso.get_info()
        elif isinstance(asurso, classes.AsyncASURSO):
            async with asurso:
                info = await asurso.get_info()
        print(info)
        assert isinstance(info, classes.Info)


__all__ = ["rejoin_asurso"]  # uuuh...
